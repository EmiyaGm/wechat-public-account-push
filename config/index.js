export const config = {
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "生日", "name": "66", "year": "1994", "date": "08-16"},
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2022-07-30"},
      ]
    },
    {
      name: "66",
      ...
      openUrl: "https://wangxinleo.cn",
      festivals: [
        {"type": "生日", "name": "你", "year": "1994", "date": "08-16"},
      ],
      customizedDateList: [
        {"keyword": "love_day", date: "2022-07-30"},
      ]
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "生日", "name": "66", "year": "1994", "date": "08-16", isShowAge: true},
    // 你可以不断按格式往下增加
    // ...
  ],
